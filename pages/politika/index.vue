      ...
      <div class="grid grid-cols-12">
        <div class="col-start-1 col-end-13 xl:col-start-3 xl:col-end-11">
          <p>
            ...
            «УЦСК «Сантехкомплект-Урал» (далее – Оператор).<br />
            ...
            Оператор может получить о посетителях веб-сайта https://santur.ru.
          </p>
          <p>
            ...
            доступность в сети интернет по сетевому адресу https://santur.ru.<br />
          ...
          <p>
            ...
            течение 30 дней с даты получения такого запроса;<br />
          ...
          <p>
            <strong>6. Принципы обработки персональных данных</strong><br />
          ...
          <p>
            <strong>7. Цели обработки персональных данных</strong><br />
            ...
            материалам, содержащимся на веб-сайте https://santur.ru.<br />
            ...
            электронной почты santur@santur.ru с пометкой «Отказ от уведомлений
          ...
          <p>
            ...
            через специальные формы, расположенные на сайте https://santur.ru
          ...
          <p>
            <strong>9. Условия обработки персональных данных</strong><br />
          ...
          <p>
            ...
            Оператора santur@santur.ru с пометкой «Актуализация персональных
            данных».<br />
            ...
            не предусмотрен договором или действующим законодательством.<br />
            ...
            santur@santur.ru с пометкой «Отзыв согласия на обработку
            персональных данных».<br />
            ...
            лиц, в том числе указанных в настоящем пункте поставщиков услуг.<br />
          ...
          <p>
            <strong>13. Конфиденциальность персональных данных</strong><br />
          ...
          <p>
            ...
            к Оператору с помощью электронной почты santur@santur.ru.<br />
            ...
            сети Интернет по адресу https://santur.ru/politika/.
          </p>
        </div>
      </div>
    </div>
...
const breadcrumbs = [{ name: title, url: "/politika" }];
</script>
