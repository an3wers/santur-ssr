<template>
  <div class="header-catalog-dropdown">
    ...
    <div class="header-catalog-dropdown__menu">
      <!-- Категория -->
      <div
        class="menu border-r border-gray-200 scrollbar-thin scrollbar-thumb-gray-300 scrollbar-track-gray-200"
      >
        <div class="flex justify-between items-baseline">
          <h4 class="font-bold text-lg mb-4 pr-4">Каталог</h4>
          <NuxtLink class="mr-4 text-gray-800 text-sm" to="/catalog"
      ...
      <div
        ...
        ref="dropdownSubmenu"
        class="submenu scrollbar-thin scrollbar-thumb-gray-300 scrollbar-track-gray-200"
      >
        ...
        <div class="menu-list submenu-list">
          <div
            ...
            class="menu-list__item"
          >
            <NuxtLink :to="`/catalog/${subitem.id}`">{{
              subitem.name
            }}</NuxtLink>
          </div>
        </div>
