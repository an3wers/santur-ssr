<template>
  <div class="product-descr mt-6">
    ...
    <div class="font-medium text-center border-b sticky top-0 bg-white/80">
      <ul
        class="product-descr__nav flex flex-nowrap -mb-px space-x-6 overflow-x-auto"
      >
        <li
    ...
    <div v-if="enableSection.length">
      ...
      >
        <div
          v-if="section.alias === 'characteristics'"
          class="col-start-1 col-end-13 lg:col-end-8"
        >
        ...
        <!-- test: -->
        <div v-else class="col-start-1 col-end-8"></div>
      </product-descr-section>
    </div>
  </div>
</template>
